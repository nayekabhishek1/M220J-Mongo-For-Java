...
public class CommentDao extends AbstractMFlixDao {
	...
	public Comment addComment(Comment comment) {
		...
		// DONE> Ticket - Update User reviews: implement the functionality that enables
		// adding a new
		// comment.
	...
	public boolean updateComment(String commentId, String text, String email) {
		...
		// handle a potential write exception when given a wrong commentId.
		try {
			ur = commentCollection.updateOne(and(eq("_id", new ObjectId(commentId)), eq("email", email)),
	...
	public boolean deleteComment(String commentId, String email) {
		// DONE> Ticket Delete Comments - Implement the method that enables the deletion
		// of a user
		// comment
		...
		// handle a potential write exception when given a wrong commentId.
		try {
			dr = commentCollection.deleteOne(and(eq("_id", new ObjectId(commentId)), eq("email", email)));
		} catch (MongoException ex) {
	...
	public List<Critic> mostActiveCommenters() {
		...
		// // DONE> Ticket: User Report - execute a command that returns the
