...
public class Migrator {
    ...
    private static UpdateOneModel<Document> transformRating(Document doc) {
        try {
			...
			return new UpdateOneModel<Document>(eq("_id", doc.getObjectId("_id")), set("imdb.rating", rating));
    ...
    public static void main(String[] args) {
        ...
        String mongoUri = "mongodb+srv://m220student:m220password@mflix.owxuv.mongodb.net/test";
